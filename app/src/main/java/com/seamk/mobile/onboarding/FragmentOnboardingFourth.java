...
public class FragmentOnboardingFourth extends Fragment implements ISlideBackgroundColorHolder {
    @Override
    public int getDefaultBackgroundColor() {
        // Return the default background color of the slide.
        return Color.parseColor("#1fb43a");
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageView.setImageDrawable(getActivity().getResources().getDrawable(R.drawable.image_onboarding_second));
        textViewTitle.setText(getResources().getString(R.string.intro_search_title));
        textViewDesc.setText(getResources().getString(R.string.intro_search_desc));
