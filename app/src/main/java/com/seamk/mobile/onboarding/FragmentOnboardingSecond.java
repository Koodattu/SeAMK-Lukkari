...
public class FragmentOnboardingSecond extends Fragment implements ISlideBackgroundColorHolder {
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textViewTitle.setText(getResources().getString(R.string.intro_basic_title));
        textViewDesc.setText(getResources().getString(R.string.intro_search_desc));
        frameLayout.setBackgroundColor(getResources().getColor(R.color.seamkGreen));
        return v;
    }
}
